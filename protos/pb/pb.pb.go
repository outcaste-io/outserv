...
const (
	NQuad_SET NQuad_Op = 0
	NQuad_DEL NQuad_Op = 1
)

var NQuad_Op_name = map[int32]string{
	0: "SET",
	1: "DEL",
}

var NQuad_Op_value = map[string]int32{
	"SET": 0,
	"DEL": 1,
}

func (x NQuad_Op) String() string {
	return proto.EnumName(NQuad_Op_name, int32(x))
}

func (NQuad_Op) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f80abaa17e25ccc8, []int{47, 0}
}
...
type Object struct {
	...
	Nquads []*NQuad `protobuf:"bytes,3,rep,name=nquads,proto3" json:"nquads,omitempty"`
}
...
type Mutations struct {
	...
	Nquads     []*NQuad         `protobuf:"bytes,3,rep,name=nquads,proto3" json:"nquads,omitempty"`
	Edges      []*DirectedEdge  `protobuf:"bytes,4,rep,name=edges,proto3" json:"edges,omitempty"`
...
func (m *Mutations) GetNquads() []*NQuad {
	if m != nil {
		return m.Nquads
	}
	return nil
...
func (m *Mutation) GetNquads() []*NQuad {
	if m != nil {
		return m.Nquads
	}
	return nil
...
type NQuad struct {
	...
	Op          NQuad_Op `protobuf:"varint,6,opt,name=op,proto3,enum=pb.NQuad_Op" json:"op,omitempty"`
}
...
func init() {
	...
	proto.RegisterEnum("pb.NQuad_Op", NQuad_Op_name, NQuad_Op_value)
...
var fileDescriptor_f80abaa17e25ccc8 = []byte{
	...
	,
}
...
func (m *Object) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Nquads) > 0 {
		for iNdEx := len(m.Nquads) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Nquads[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Object) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Nquads", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Nquads = append(m.Nquads, &NQuad{})
			if err := m.Nquads[len(m.Nquads)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
