...
type LambdaUpdate_Directive int32

const (
	LambdaUpdate_NONE    LambdaUpdate_Directive = 0
	LambdaUpdate_INDEX   LambdaUpdate_Directive = 1
	LambdaUpdate_REVERSE LambdaUpdate_Directive = 2
	LambdaUpdate_DELETE  LambdaUpdate_Directive = 3
)

var LambdaUpdate_Directive_name = map[int32]string{
	0: "NONE",
	1: "INDEX",
	2: "REVERSE",
	3: "DELETE",
...
var LambdaUpdate_Directive_value = map[string]int32{
	"NONE":    0,
	"INDEX":   1,
	"REVERSE": 2,
	"DELETE":  3,
...
func (x LambdaUpdate_Directive) String() string {
	return proto.EnumName(LambdaUpdate_Directive_name, int32(x))
}

func (LambdaUpdate_Directive) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f80abaa17e25ccc8, []int{30, 0}
}
...
func (Request_RespFormat) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f80abaa17e25ccc8, []int{37, 0}
}
...
func (Operation_DropOp) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f80abaa17e25ccc8, []int{42, 0}
}
...
func (NumLeaseType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f80abaa17e25ccc8, []int{55, 0}
}
...
type MembershipState struct {
	...
	Leaders     map[uint32]uint64  `protobuf:"bytes,2,rep,name=leaders,proto3" json:"leaders,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	Tablets     map[string]*Tablet `protobuf:"bytes,3,rep,name=tablets,proto3" json:"tablets,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Removed     []uint64           `protobuf:"varint,4,rep,packed,name=removed,proto3" json:"removed,omitempty"`
...
func (m *MembershipState) GetLeaders() map[uint32]uint64 {
	if m != nil {
		return m.Leaders
	}
	return nil
...
type LambdaUpdate struct {
	Predicate string                 `protobuf:"bytes,1,opt,name=predicate,proto3" json:"predicate,omitempty"`
	ValueType Posting_ValType        `protobuf:"varint,2,opt,name=value_type,json=valueType,proto3,enum=pb.Posting_ValType" json:"value_type,omitempty"`
	Directive LambdaUpdate_Directive `protobuf:"varint,3,opt,name=directive,proto3,enum=pb.LambdaUpdate_Directive" json:"directive,omitempty"`
	Tokenizer []string               `protobuf:"bytes,4,rep,name=tokenizer,proto3" json:"tokenizer,omitempty"`
	Count     bool                   `protobuf:"varint,5,opt,name=count,proto3" json:"count,omitempty"`
	List      bool                   `protobuf:"varint,6,opt,name=list,proto3" json:"list,omitempty"`
	Upsert    bool                   `protobuf:"varint,7,opt,name=upsert,proto3" json:"upsert,omitempty"`
...
func (m *LambdaUpdate) Reset()         { *m = LambdaUpdate{} }
func (m *LambdaUpdate) String() string { return proto.CompactTextString(m) }
func (*LambdaUpdate) ProtoMessage()    {}
func (*LambdaUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_f80abaa17e25ccc8, []int{30}
}
func (m *LambdaUpdate) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LambdaUpdate) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LambdaUpdate.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LambdaUpdate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LambdaUpdate.Merge(m, src)
}
func (m *LambdaUpdate) XXX_Size() int {
	return m.Size()
}
func (m *LambdaUpdate) XXX_DiscardUnknown() {
	xxx_messageInfo_LambdaUpdate.DiscardUnknown(m)
}

var xxx_messageInfo_LambdaUpdate proto.InternalMessageInfo

func (m *LambdaUpdate) GetPredicate() string {
	if m != nil {
		return m.Predicate
	}
	return ""
...
func (m *LambdaUpdate) GetValueType() Posting_ValType {
	if m != nil {
		return m.ValueType
	}
	return Posting_DEFAULT
...
func (m *LambdaUpdate) GetDirective() LambdaUpdate_Directive {
	if m != nil {
		return m.Directive
	}
	return LambdaUpdate_NONE
}

func (m *LambdaUpdate) GetTokenizer() []string {
	if m != nil {
		return m.Tokenizer
	}
	return nil
...
func (m *LambdaUpdate) GetCount() bool {
	if m != nil {
		return m.Count
	}
	return false
...
func (m *LambdaUpdate) GetList() bool {
	if m != nil {
		return m.List
	}
	return false
...
func (m *LambdaUpdate) GetUpsert() bool {
	if m != nil {
		return m.Upsert
	}
	return false
...
type UpdateLambdaScriptRequest struct {
	StartTs      uint64 `protobuf:"varint,1,opt,name=start_ts,json=startTs,proto3" json:"start_ts,omitempty"`
	LambdaScript []byte `protobuf:"bytes,2,opt,name=lambda_script,json=lambdaScript,proto3" json:"lambda_script,omitempty"`
}

func (m *UpdateLambdaScriptRequest) Reset()         { *m = UpdateLambdaScriptRequest{} }
func (m *UpdateLambdaScriptRequest) String() string { return proto.CompactTextString(m) }
func (*UpdateLambdaScriptRequest) ProtoMessage()    {}
func (*UpdateLambdaScriptRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f80abaa17e25ccc8, []int{65}
}
func (m *UpdateLambdaScriptRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UpdateLambdaScriptRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UpdateLambdaScriptRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UpdateLambdaScriptRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateLambdaScriptRequest.Merge(m, src)
}
func (m *UpdateLambdaScriptRequest) XXX_Size() int {
	return m.Size()
}
func (m *UpdateLambdaScriptRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateLambdaScriptRequest.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateLambdaScriptRequest proto.InternalMessageInfo

func (m *UpdateLambdaScriptRequest) GetStartTs() uint64 {
	if m != nil {
		return m.StartTs
	}
	return 0
...
func (m *UpdateLambdaScriptRequest) GetLambdaScript() []byte {
	if m != nil {
...
type UpdateLambdaScriptResponse struct {
	Uid  uint64 `protobuf:"varint,1,opt,name=uid,proto3" json:"uid,omitempty"`
	Hash string `protobuf:"bytes,2,opt,name=hash,proto3" json:"hash,omitempty"`
}

func (m *UpdateLambdaScriptResponse) Reset()         { *m = UpdateLambdaScriptResponse{} }
func (m *UpdateLambdaScriptResponse) String() string { return proto.CompactTextString(m) }
func (*UpdateLambdaScriptResponse) ProtoMessage()    {}
func (*UpdateLambdaScriptResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f80abaa17e25ccc8, []int{66}
}
func (m *UpdateLambdaScriptResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UpdateLambdaScriptResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UpdateLambdaScriptResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UpdateLambdaScriptResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateLambdaScriptResponse.Merge(m, src)
}
func (m *UpdateLambdaScriptResponse) XXX_Size() int {
	return m.Size()
}
func (m *UpdateLambdaScriptResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateLambdaScriptResponse.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateLambdaScriptResponse proto.InternalMessageInfo

func (m *UpdateLambdaScriptResponse) GetUid() uint64 {
	if m != nil {
		return m.Uid
	}
	return 0
...
func (m *UpdateLambdaScriptResponse) GetHash() string {
	if m != nil {
		return m.Hash
	}
	return ""
...
func (*TaskStatusResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f80abaa17e25ccc8, []int{70}
}
...
func init() {
	...
	proto.RegisterEnum("pb.LambdaUpdate_Directive", LambdaUpdate_Directive_name, LambdaUpdate_Directive_value)
	...
	proto.RegisterMapType((map[uint32]uint64)(nil), "pb.MembershipState.LeadersEntry")
	...
	proto.RegisterType((*LambdaUpdate)(nil), "pb.LambdaUpdate")
	...
	proto.RegisterType((*UpdateLambdaScriptRequest)(nil), "pb.UpdateLambdaScriptRequest")
	proto.RegisterType((*UpdateLambdaScriptResponse)(nil), "pb.UpdateLambdaScriptResponse")
...
var fileDescriptor_f80abaa17e25ccc8 = []byte{
	...
	,
}
...
type WorkerClient interface {
	...
	UpdateLambdaScript(ctx context.Context, in *UpdateLambdaScriptRequest, opts ...grpc.CallOption) (*UpdateLambdaScriptResponse, error)
...
func (c *workerClient) UpdateLambdaScript(ctx context.Context, in *UpdateLambdaScriptRequest, opts ...grpc.CallOption) (*UpdateLambdaScriptResponse, error) {
	out := new(UpdateLambdaScriptResponse)
	err := c.cc.Invoke(ctx, "/pb.Worker/UpdateLambdaScript", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WorkerServer interface {
	...
	UpdateLambdaScript(context.Context, *UpdateLambdaScriptRequest) (*UpdateLambdaScriptResponse, error)
...
func (*UnimplementedWorkerServer) UpdateLambdaScript(ctx context.Context, req *UpdateLambdaScriptRequest) (*UpdateLambdaScriptResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateLambdaScript not implemented")
}
...
func _Worker_UpdateLambdaScript_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateLambdaScriptRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkerServer).UpdateLambdaScript(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Worker/UpdateLambdaScript",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkerServer).UpdateLambdaScript(ctx, req.(*UpdateLambdaScriptRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Worker_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateLambdaScript",
			Handler:    _Worker_UpdateLambdaScript_Handler,
		},
		{
...
func (m *LambdaUpdate) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LambdaUpdate) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LambdaUpdate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *UpdateLambdaScriptRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UpdateLambdaScriptRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdateLambdaScriptRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *UpdateLambdaScriptResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UpdateLambdaScriptResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdateLambdaScriptResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *LambdaUpdate) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UpdateLambdaScriptRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UpdateLambdaScriptResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MembershipState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Leaders == nil {
				m.Leaders = make(map[uint32]uint64)
			}
			var mapkey uint32
			var mapvalue uint64
			for iNdEx < postIndex {
...
func (m *LambdaUpdate) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LambdaUpdate: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LambdaUpdate: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Directive |= LambdaUpdate_Directive(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *UpdateLambdaScriptRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateLambdaScriptRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateLambdaScriptRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			...
			m.LambdaScript = append(m.LambdaScript[:0], dAtA[iNdEx:postIndex]...)
			if m.LambdaScript == nil {
				m.LambdaScript = []byte{}
			}
			iNdEx = postIndex
		default:
...
func (m *UpdateLambdaScriptResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateLambdaScriptResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateLambdaScriptResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
