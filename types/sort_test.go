...
func TestSortStrings(t *testing.T) {
	...
	ul := getUIDList(4)
	require.NoError(t, Sort(list, &ul.SortedUids, []bool{false}, ""))
	require.EqualValues(t, []uint64{300, 200, 400, 100}, ul.SortedUids)
...
func TestSortLanguage(t *testing.T) {
	...
	require.NoError(t, Sort(list, &ul.SortedUids, []bool{false}, "de"))
	require.EqualValues(t, []uint64{100, 200}, ul.SortedUids)
	...
	require.NoError(t, Sort(list, &ul.SortedUids, []bool{false}, "sv"))
	require.EqualValues(t, []uint64{200, 100}, ul.SortedUids)
...
func TestSortInts(t *testing.T) {
	...
	ul := getUIDList(4)
	require.NoError(t, Sort(list, &ul.SortedUids, []bool{false}, ""))
	require.EqualValues(t, []uint64{300, 100, 200, 400}, ul.SortedUids)
...
func TestSortFloats(t *testing.T) {
	...
	ul := getUIDList(4)
	require.NoError(t, Sort(list, &ul.SortedUids, []bool{false}, ""))
	require.EqualValues(t, []uint64{400, 200, 300, 100}, ul.SortedUids)
...
func TestSortFloatsDesc(t *testing.T) {
	list := getInput(t, FloatID, []string{"22.2", "11.2", "11.5", "2.12"})
	ul := getUIDList(4)
	require.NoError(t, Sort(list, &ul.SortedUids, []bool{true}, ""))
	require.EqualValues(t, []uint64{100, 300, 200, 400}, ul.SortedUids)
	require.EqualValues(t,
...
func TestSortIntAndFloat(t *testing.T) {
	...
	ul := getUIDList(3)
	require.NoError(t, Sort(list, &ul.SortedUids, []bool{false}, ""))
	require.EqualValues(t, []uint64{200, 100, 300}, ul.SortedUids)
	require.EqualValues(t,
		[]string{"21.5", "55", "100"},
		toString(t, list, DateTimeID))
...
func TestSortMismatchedTypes(t *testing.T) {
	...
	catIdx := findIndex(t, ul.SortedUids, 100)
	aarIdx := findIndex(t, ul.SortedUids, 500)
	bufIdx := findIndex(t, ul.SortedUids, 600)
	require.True(t, aarIdx < bufIdx)
	require.True(t, bufIdx < catIdx)

	idx55 := findIndex(t, ul.SortedUids, 200)
	idx21 := findIndex(t, ul.SortedUids, 400)
	idx33 := findIndex(t, ul.SortedUids, 700)
