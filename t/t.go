...
//go:generate -command Compose compose -q --local=false --names=false --port_offset=0 --expose_ports=false --mem= --num_alphas 1 --num_zeros 1 --image=outcaste/outserv --tag=test
//go:generate -command ComposeTls compose -q --local=false --names=false --port_offset=0 --expose_ports=false --mem= --num_alphas 1 --num_zeros 1 --image=outcaste/outserv --tag=test --custom_alpha_options=1:--tls="ca-cert=/dgraph-tls/alpha1/ca.crt;server-cert=/dgraph-tls/alpha1/node.crt;server-key=/dgraph-tls/alpha1/node.key;internal-port=true;client-cert=/dgraph-tls/alpha1/client.alpha1.crt;client-key=/dgraph-tls/alpha2/client.alpha1.key;" --custom_alpha_options=2:--tls="ca-cert=/dgraph-tls/alpha2/ca.crt;server-cert=/dgraph-tls/alpha2/node.crt;server-key=/dgraph-tls/alpha2/node.key;internal-port=true;client-cert=/dgraph-tls/alpha2/client.alpha2.crt;client-key=/dgraph-tls/alpha2/client.alpha2.key;" --custom_alpha_options=3:--tls="ca-cert=/dgraph-tls/alpha3/ca.crt;server-cert=/dgraph-tls/alpha3/node.crt;server-key=/dgraph-tls/alpha3/node.key;internal-port=true;client-cert=/dgraph-tls/alpha3/client.alpha3.crt;client-key=/dgraph-tls/alpha3/client.alpha3.key;" --custom_alpha_options=4:--tls="ca-cert=/dgraph-tls/alpha4/ca.crt;server-cert=/dgraph-tls/alpha4/node.crt;server-key=/dgraph-tls/alpha4/node.key;internal-port=true;client-cert=/dgraph-tls/alpha4/client.alpha4.crt;client-key=/dgraph-tls/alpha4/client.alpha4.key;" --custom_alpha_options=5:--tls="ca-cert=/dgraph-tls/alpha5/ca.crt;server-cert=/dgraph-tls/alpha5/node.crt;server-key=/dgraph-tls/alpha5/node.key;internal-port=true;client-cert=/dgraph-tls/alpha5/client.alpha5.crt;client-key=/dgraph-tls/alpha5/client.alpha5.key;" --custom_alpha_options=6:--tls="ca-cert=/dgraph-tls/alpha6/ca.crt;server-cert=/dgraph-tls/alpha6/node.crt;server-key=/dgraph-tls/alpha6/node.key;internal-port=true;client-cert=/dgraph-tls/alpha6/client.alpha6.crt;client-key=/dgraph-tls/alpha6/client.alpha6.key;" --custom_zero_options=1:--tls="ca-cert=/dgraph-tls/zero1/ca.crt;server-cert=/dgraph-tls/zero1/node.crt;server-key=/dgraph-tls/zero1/node.key;internal-port=true;client-cert=/dgraph-tls/zero1/client.zero1.crt;client-key=/dgraph-tls/zero2/client.zero1.key;" --custom_zero_options=2:--tls="ca-cert=/dgraph-tls/zero2/ca.crt;server-cert=/dgraph-tls/zero2/node.crt;server-key=/dgraph-tls/zero2/node.key;internal-port=true;client-cert=/dgraph-tls/zero2/client.zero2.crt;client-key=/dgraph-tls/zero2/client.zero2.key;" --custom_zero_options=3:--tls="ca-cert=/dgraph-tls/zero3/ca.crt;server-cert=/dgraph-tls/zero3/node.crt;server-key=/dgraph-tls/zero3/node.key;internal-port=true;client-cert=/dgraph-tls/zero3/client.zero3.crt;client-key=/dgraph-tls/zero3/client.zero3.key;" --alpha_volume ../tls:/dgraph-tls:ro --zero_volume ../tls:/dgraph-tls:ro
...
//go:generate Compose -O ../systest/loader/docker-compose.yml						--alpha_volume ../../tlstest/mtls_internal/tls:/dgraph-tls:ro --zero_volume ../../tlstest/mtls_internal/tls:/dgraph-tls:ro  --custom_alpha_options=1:--tls="ca-cert=/dgraph-tls/alpha1/ca.crt;server-cert=/dgraph-tls/alpha1/node.crt;server-key=/dgraph-tls/alpha1/node.key;internal-port=true;client-cert=/dgraph-tls/alpha1/client.alpha1.crt;client-key=/dgraph-tls/alpha2/client.alpha1.key;" --custom_zero_options=1:--tls="ca-cert=/dgraph-tls/zero1/ca.crt;server-cert=/dgraph-tls/zero1/node.crt;server-key=/dgraph-tls/zero1/node.key;internal-port=true;client-cert=/dgraph-tls/zero1/client.zero1.crt;client-key=/dgraph-tls/zero2/client.zero1.key;"
//go:generate Compose -O ../systest/online-restore/docker-compose.yml				--num_alphas 6 --num_zeros 1  --alpha_volume ./keys:/data/keys:ro --alpha_volume ./backup:/data/backup2:ro --alpha_volume backup:/data/backup --alpha_volume ../../tlstest/mtls_internal/tls:/dgraph-tls:ro --zero_volume ../../tlstest/mtls_internal/tls:/dgraph/tls:ro --custom_alpha_options=1:--tls="ca-cert=/dgraph-tls/alpha1/ca.crt;server-cert=/dgraph-tls/alpha1/node.crt;server-key=/dgraph-tls/alpha1/node.key;internal-port=true;client-cert=/dgraph-tls/alpha1/client.alpha1.crt;client-key=/dgraph-tls/alpha2/client.alpha1.key;" --custom_alpha_options=2:--tls="ca-cert=/dgraph-tls/alpha2/ca.crt;server-cert=/dgraph-tls/alpha2/node.crt;server-key=/dgraph-tls/alpha2/node.key;internal-port=true;client-cert=/dgraph-tls/alpha2/client.alpha2.crt;client-key=/dgraph-tls/alpha2/client.alpha2.key;" --custom_alpha_options=3:--tls="ca-cert=/dgraph-tls/alpha3/ca.crt;server-cert=/dgraph-tls/alpha3/node.crt;server-key=/dgraph-tls/alpha3/node.key;internal-port=true;client-cert=/dgraph-tls/alpha3/client.alpha3.crt;client-key=/dgraph-tls/alpha3/client.alpha3.key;" --custom_alpha_options=4:--tls="ca-cert=/dgraph-tls/alpha4/ca.crt;server-cert=/dgraph-tls/alpha4/node.crt;server-key=/dgraph-tls/alpha4/node.key;internal-port=true;client-cert=/dgraph-tls/alpha4/client.alpha4.crt;client-key=/dgraph-tls/alpha4/client.alpha4.key;" --custom_alpha_options=5:--tls="ca-cert=/dgraph-tls/alpha5/ca.crt;server-cert=/dgraph-tls/alpha5/node.crt;server-key=/dgraph-tls/alpha5/node.key;internal-port=true;client-cert=/dgraph-tls/alpha5/client.alpha5.crt;client-key=/dgraph-tls/alpha5/client.alpha5.key;" --custom_alpha_options=6:--tls="ca-cert=/dgraph-tls/alpha6/ca.crt;server-cert=/dgraph-tls/alpha6/node.crt;server-key=/dgraph-tls/alpha6/node.key;internal-port=true;client-cert=/dgraph-tls/alpha6/client.alpha6.crt;client-key=/dgraph-tls/alpha6/client.alpha6.key;" --custom_zero_options=1:--tls="ca-cert=/dgraph-tls/zero1/ca.crt;server-cert=/dgraph-tls/zero1/node.crt;server-key=/dgraph-tls/zero1/node.key;internal-port=true;client-cert=/dgraph-tls/zero1/client.zero1.crt;client-key=/dgraph-tls/zero2/client.zero1.key;"
...
//go:generate Compose -O ../tlstest/mtls_internal/ha_6_node/docker-compose.yml		--num_alphas 3 --num_zeros 3 --custom_alpha_options=1:--tls="ca-cert=/dgraph-tls/alpha1/ca.crt;server-cert=/dgraph-tls/alpha1/node.crt;server-key=/dgraph-tls/alpha1/node.key;internal-port=true;client-cert=/dgraph-tls/alpha1/client.alpha1.crt;client-key=/dgraph-tls/alpha2/client.alpha1.key;" --custom_alpha_options=2:--tls="ca-cert=/dgraph-tls/alpha2/ca.crt;server-cert=/dgraph-tls/alpha2/node.crt;server-key=/dgraph-tls/alpha2/node.key;internal-port=true;client-cert=/dgraph-tls/alpha2/client.alpha2.crt;client-key=/dgraph-tls/alpha2/client.alpha2.key;" --custom_alpha_options=3:--tls="ca-cert=/dgraph-tls/alpha3/ca.crt;server-cert=/dgraph-tls/alpha3/node.crt;server-key=/dgraph-tls/alpha3/node.key;internal-port=true;client-cert=/dgraph-tls/alpha3/client.alpha3.crt;client-key=/dgraph-tls/alpha3/client.alpha3.key;" --custom_zero_options=1:--tls="ca-cert=/dgraph-tls/zero1/ca.crt;server-cert=/dgraph-tls/zero1/node.crt;server-key=/dgraph-tls/zero1/node.key;internal-port=true;client-cert=/dgraph-tls/zero1/client.zero1.crt;client-key=/dgraph-tls/zero2/client.zero1.key;" --custom_zero_options=2:--tls="ca-cert=/dgraph-tls/zero2/ca.crt;server-cert=/dgraph-tls/zero2/node.crt;server-key=/dgraph-tls/zero2/node.key;internal-port=true;client-cert=/dgraph-tls/zero2/client.zero2.crt;client-key=/dgraph-tls/zero2/client.zero2.key;" --custom_zero_options=3:--tls="ca-cert=/dgraph-tls/zero3/ca.crt;server-cert=/dgraph-tls/zero3/node.crt;server-key=/dgraph-tls/zero3/node.key;internal-port=true;client-cert=/dgraph-tls/zero3/client.zero3.crt;client-key=/dgraph-tls/zero3/client.zero3.key;" --alpha_volume ../tls:/dgraph-tls:ro --zero_volume ../tls:/dgraph-tls:ro
//go:generate Compose -O ../tlstest/mtls_internal/multi_group/docker-compose.yml	--num_alphas 3 --num_zeros 3 --custom_alpha_options=1:--tls="ca-cert=/dgraph-tls/alpha1/ca.crt;server-cert=/dgraph-tls/alpha1/node.crt;server-key=/dgraph-tls/alpha1/node.key;internal-port=true;client-cert=/dgraph-tls/alpha1/client.alpha1.crt;client-key=/dgraph-tls/alpha2/client.alpha1.key;" --custom_alpha_options=2:--tls="ca-cert=/dgraph-tls/alpha2/ca.crt;server-cert=/dgraph-tls/alpha2/node.crt;server-key=/dgraph-tls/alpha2/node.key;internal-port=true;client-cert=/dgraph-tls/alpha2/client.alpha2.crt;client-key=/dgraph-tls/alpha2/client.alpha2.key;" --custom_alpha_options=3:--tls="ca-cert=/dgraph-tls/alpha3/ca.crt;server-cert=/dgraph-tls/alpha3/node.crt;server-key=/dgraph-tls/alpha3/node.key;internal-port=true;client-cert=/dgraph-tls/alpha3/client.alpha3.crt;client-key=/dgraph-tls/alpha3/client.alpha3.key;" --custom_zero_options=1:--tls="ca-cert=/dgraph-tls/zero1/ca.crt;server-cert=/dgraph-tls/zero1/node.crt;server-key=/dgraph-tls/zero1/node.key;internal-port=true;client-cert=/dgraph-tls/zero1/client.zero1.crt;client-key=/dgraph-tls/zero2/client.zero1.key;" --custom_zero_options=2:--tls="ca-cert=/dgraph-tls/zero2/ca.crt;server-cert=/dgraph-tls/zero2/node.crt;server-key=/dgraph-tls/zero2/node.key;internal-port=true;client-cert=/dgraph-tls/zero2/client.zero2.crt;client-key=/dgraph-tls/zero2/client.zero2.key;" --custom_zero_options=3:--tls="ca-cert=/dgraph-tls/zero3/ca.crt;server-cert=/dgraph-tls/zero3/node.crt;server-key=/dgraph-tls/zero3/node.key;internal-port=true;client-cert=/dgraph-tls/zero3/client.zero3.crt;client-key=/dgraph-tls/zero3/client.zero3.key;" --alpha_volume ../tls:/dgraph-tls:ro --zero_volume ../tls:/dgraph-tls:ro
//go:generate Compose -O ../tlstest/mtls_internal/single_node/docker-compose.yml	--num_alphas 1 --num_zeros 1 --custom_alpha_options=1:--tls="ca-cert=/dgraph-tls/alpha1/ca.crt;server-cert=/dgraph-tls/alpha1/node.crt;server-key=/dgraph-tls/alpha1/node.key;internal-port=true;client-cert=/dgraph-tls/alpha1/client.alpha1.crt;client-key=/dgraph-tls/alpha2/client.alpha1.key;" --custom_alpha_options=2:--tls="ca-cert=/dgraph-tls/alpha2/ca.crt;server-cert=/dgraph-tls/alpha2/node.crt;server-key=/dgraph-tls/alpha2/node.key;internal-port=true;client-cert=/dgraph-tls/alpha2/client.alpha2.crt;client-key=/dgraph-tls/alpha2/client.alpha2.key;" --custom_alpha_options=3:--tls="ca-cert=/dgraph-tls/alpha3/ca.crt;server-cert=/dgraph-tls/alpha3/node.crt;server-key=/dgraph-tls/alpha3/node.key;internal-port=true;client-cert=/dgraph-tls/alpha3/client.alpha3.crt;client-key=/dgraph-tls/alpha3/client.alpha3.key;" --custom_zero_options=1:--tls="ca-cert=/dgraph-tls/zero1/ca.crt;server-cert=/dgraph-tls/zero1/node.crt;server-key=/dgraph-tls/zero1/node.key;internal-port=true;client-cert=/dgraph-tls/zero1/client.zero1.crt;client-key=/dgraph-tls/zero2/client.zero1.key;" --custom_zero_options=2:--tls="ca-cert=/dgraph-tls/zero2/ca.crt;server-cert=/dgraph-tls/zero2/node.crt;server-key=/dgraph-tls/zero2/node.key;internal-port=true;client-cert=/dgraph-tls/zero2/client.zero2.crt;client-key=/dgraph-tls/zero2/client.zero2.key;" --custom_zero_options=3:--tls="ca-cert=/dgraph-tls/zero3/ca.crt;server-cert=/dgraph-tls/zero3/node.crt;server-key=/dgraph-tls/zero3/node.key;internal-port=true;client-cert=/dgraph-tls/zero3/client.zero3.crt;client-key=/dgraph-tls/zero3/client.zero3.key;" --alpha_volume ../tls:/dgraph-tls:ro --zero_volume ../tls:/dgraph-tls:ro
//go:generate Compose -O ../tlstest/zero_https/all_routes_tls/docker-compose.yml	--custom_zero_options=1:--tls="ca-cert=/dgraph-tls/ca.crt;server-cert=/dgraph-tls/node.crt;server-key=/dgraph-tls/node.key" --zero_volume ../../tls:/dgraph-tls:ro
//go:generate Compose -O ../tlstest/zero_https/no_tls/docker-compose.yml
//go:generate Compose -O ../worker/docker-compose.yml								--num_alphas 6 --num_zeros 3 --snapshot_after=snapshot-after-entries=100;
package main
